...
{
    //Originally from:
    //https://www.codeproject.com/articles/14908/command-prompt-control
    ...
    public partial class CommandPromptControl : UserControl
    {
        ...
        public void SetWholeThingFont(Font font)
        {
            txtInput.Font = font;
            rtbMessages.Font = font;
            lblPrompt.Font = font;
        }
        ...
        private void AdjustMessagesPanelSize()
        {
